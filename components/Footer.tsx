...
export function Footer() { return <footer className="site-footer border-t border-line bg-paper px-5 pb-[calc(3rem+var(--mobile-bar-reserve))] pt-14 md:px-10 md:pb-12">
  <div className="mx-auto grid max-w-[1400px] gap-10 md:grid-cols-[1fr_auto_auto] md:items-start">
    <div className="min-w-0"><Link href="/" className="focus-ring text-lg font-semibold tracking-tight">Quality Enterprises</Link><p className="mt-4 max-w-sm break-words text-sm text-ink-soft">Corrugated packaging for shipping, storage and handling. Manufactured at IDA Mallapur, Hyderabad.</p></div>
